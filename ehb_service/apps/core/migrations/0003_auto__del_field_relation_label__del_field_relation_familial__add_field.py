...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Relation.label'
        db.delete_column(u'core_relation', 'label')

        # Deleting field 'Relation.familial'
        db.delete_column(u'core_relation', 'familial')

        # Adding field 'Relation.typ'
        db.add_column(u'core_relation', 'typ',
                      self.gf('django.db.models.fields.CharField')(default='Label', max_length=255),
                      keep_default=False)

        # Adding field 'Relation.desc'
        db.add_column(u'core_relation', 'desc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Relation.label'
        raise RuntimeError("Cannot reverse this migration. 'Relation.label' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'Relation.label'
        db.add_column(u'core_relation', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Adding field 'Relation.familial'
        db.add_column(u'core_relation', 'familial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Relation.typ'
        db.delete_column(u'core_relation', 'typ')

        # Deleting field 'Relation.desc'
        db.delete_column(u'core_relation', 'desc')
