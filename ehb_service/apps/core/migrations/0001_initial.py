    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(help_text=b'Please use date format: <em>YYYY-MM-DD</em>', verbose_name=b'Record Creation DateTime', auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True, auto_now_add=True, help_text=b'Please use date format: <em>YYYY-MM-DD</em>', verbose_name=b'Record Last Modified DateTime')),
                ('name', core.encryption.encryptionFields.EncryptCharField(unique=True, verbose_name=b'Group Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(help_text=b'Please use date format: <em>YYYY-MM-DD</em>', verbose_name=b'Record Creation DateTime', auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True, auto_now_add=True, help_text=b'Please use date format: <em>YYYY-MM-DD</em>', verbose_name=b'Record Last Modified DateTime')),
                ('key', core.encryption.encryptionFields.EncryptCharField(verbose_name=b'EHB KEY', unique=True, editable=False, blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True, auto_now_add=True, help_text=b'Please use date format: <em>YYYY-MM-DD</em>', verbose_name=b'Record Last Modified DateTime')),
                ('id', models.AutoField(serialize=False, primary_key=True)),
                ('typ', models.CharField(default=b'Label', max_length=255, verbose_name=b'Relation Type', choices=[(b'generic', b'Generic'), (b'label', b'Label'), (b'file', b'File'), (b'familial', b'Familial'), (b'diagnosis', b'Diagnosis')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(help_text=b'Please use date format: <em>YYYY-MM-DD</em>', verbose_name=b'Record Creation DateTime', auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True, auto_now_add=True, help_text=b'Please use date format: <em>YYYY-MM-DD</em>', verbose_name=b'Record Last Modified DateTime')),
                ('first_name', core.encryption.encryptionFields.EncryptCharField(verbose_name=b'First Name')),
                ('last_name', core.encryption.encryptionFields.EncryptCharField(verbose_name=b'Last Name')),
                ('organization_subject_id', core.encryption.encryptionFields.EncryptCharField(verbose_name=b'Organization Subject Record ID')),
                ('dob', core.encryption.encryptionFields.EncryptDateField(help_text=b'Please use date format: <em>YYYY-MM-DD</em>', verbose_name=b'Date Of Birth')),
