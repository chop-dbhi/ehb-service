...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding Model 'PedigreeRelationshipDef'
        db.create_table(u'PedigreeRelationshipDef', (
        (u'valid_values', self.gf('django.db.models.fields.CharField')(max_length=50))
        (u'value_Meaning_name', self.gf('django.db.models.fields.CharField')(max_length=50))
        (u'value_meaning_description', self.gf('django.dv.models.CharField')(max_length=50))
        ))
