...
class EmailBackend(ModelBackend):
    def authenticate(self, username=None, password=None):
        ...
        try:
            ...
            log.error("Unable to authenticate. User does not exist")
            return
...
class LdapBackend(ModelBackend):
    ...
    def authenticate(self, username=None, password=None):
        ...
        if idx > -1:
            ...
            email = '{0}@{1}'.format(username, getattr(settings, 'EMAIL_DOMAIN', 'email.chop.edu'))
        ...
        try:
            ...
            log.error("LDAP authentication error. User does not exist")
            return
